...
По запросу любой организации на ящик [r.piontik@mail.ru](mailto:r.piontik@mail.ru) информация об использовании ей DocHub будет удалена. 
Дальнейшее использование DocHub этой компанией запрещается без согласования условий возобновления использования с 
автором DocHub [R.Piontik](mailto:r.piontik@mail.ru).
