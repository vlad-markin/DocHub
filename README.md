...
Это, безусловно, тормозит развитие продукта, так как ресурсы расходуются на поддержку, а не на развитие. 
***Эту ситуацию необходимо изменить, чтобы сохранить импульс инноваций.***

## Решения проблемы

1. ***Создание коммерческого направления продукта.*** Часть ***новых*** фич будет разрабатываться под проприетарной лицензией и распространяться по подписке. 
   Клиенты, помимо эксклюзивных функций, будут получать [SLA](https://ru.wikipedia.org/wiki/%D0%A1%D0%BE%D0%B3%D0%BB%D0%B0%D1%88%D0%B5%D0%BD%D0%B8%D0%B5_%D0%BE%D0%B1_%D1%83%D1%80%D0%BE%D0%B2%D0%BD%D0%B5_%D1%83%D1%81%D0%BB%D1%83%D0%B3),
   который гарантирует стабильность работы DocHub в их компаниях. Проработка коммерческого предложения уже идет, подробности будут представлены по готовности.

2. ***Прозрачность использования FOSS DocHub.*** Одной из ключевых проблем любого продукта является доверие к нему. В ИТ это доверие заслужить сложно. 
   Обычно метрикой надежности и перспективности продукта являются его клиенты. DocHub не гнался за "лейблами" на первом этапе, ставя задачу создать реальную ценность для экспертов-инноваторов без "маркетингового давления".
   Сегодня наше сообщество велико, и мы можем с уверенностью говорить о подтверждении ценности инструмента и подхода. Скромность более неуместна.
    ...
    ***Каждый пользователь DocHub может существенно помочь его развитию, опубликовав информацию о том, в какой компании и для каких задач он используется.*** 
    Направляйте информацию на ящик [r.piontik@mail.ru](r.piontik@mail.ru) вы, безусловно, сделаете очень ценный вклад в развитие подхода "Архитектура как код".

    Начиная с релиза v3.13.1, в дополнение к лицензии Apache 2.0 вводится комьюнити-взнос в развитие DocHub. Он заключается в обязательстве пользователя ***не скрывать использование DocHub***.
    Это обязательство также касается производных продуктов на основе кодовой базы DocHub.

    Информация ***о факте*** использования компанией DocHub может без ее явного согласия публиковаться в репозиториях продукта, в информационной пространстве комьюнити, в статьях, на конференциях и т.д.
    при наличии очевидных признаков такого использования (публичные заявления, форки кодовой базы, обсуждения в экспертных сообществах и т.п.). При этом, без согласия публикуется только сам факт
    использования.

    
    ```
        Например, если архитектор компании ООО "Креативные Технологии" опубликовал статью на Хабре "Развертывание сервисов с использованием DocHub", в репозитории DocHub может появиться 
        информация об новом клиенте DocHub - ООО "Креативные Технологии". Никакой детальной информации об опыте использования без выраженного желания компании не появится.
    ```

    ***Если по какой-либо причине считаете, что использование вами DocHub не может быть публичной информацией — прекратите его использование.*** Это противоречит цели создания DocHub как FOSS инструмента.
